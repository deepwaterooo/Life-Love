...
\end{itemize}
\subsubsection{Isolation from Great Classmates}
\label{sec-12-3-2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Course Instructor's unreasonable Judge on student}
\label{sec-12-3-3}

\subsubsection{Raising questions without a point blow-up -- "to be continued\textasciitilde{}"}
\label{sec-12-3-4}
(part 3, chapter 25, 26, \textbf{page 185-188})
...
\label{sec-12-5}
\begin{itemize}
\item working on it, will update later tonight\ldots{}.
\end{itemize}
